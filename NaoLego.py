				...
				if OpenConnectors <= 5.5:
								...
								if diff <= 17512.5:
									if yValue <= 332.5:
										if diff <= 17156.5:
											...
											return True
									else:  # if yValue > 332.5
										return False
								else:  # if diff > 17512.5
									return True
					...
					if diff <= 20828.5:
						if OpenConnectors <= 6.5:
							if diff <= 18691.5:
								return True
							else:  # if diff > 18691.5
								if yValue <= 338.0:
									return False
								else:  # if yValue > 338.0
									return True
						else:  # if OpenConnectors > 6.5
							return True
					else:  # if diff > 20828.5
						if diff <= 21268.5:
							if yValue <= 285.5:
								return False
